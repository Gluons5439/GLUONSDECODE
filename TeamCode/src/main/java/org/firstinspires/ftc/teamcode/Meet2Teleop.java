...
public class Meet2Teleop extends OpMode {
    ...
    private static final double TRANSFER_DOWN_POS =.5; // Resting/Down Position
    private static final double TRANSFER_UP_POS = .7; // Flipped/Up Position
...
// D-Pad Up: Go to position 1.0 (Straight Up)
        if (dpad_up2_is_pressed && !dpad_up2_was_pressed) {
            transfer1TargetPosition = 0.5; // 1.0
        }
